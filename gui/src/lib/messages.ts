export const MESSAGES = {
  ...
  ja: {
    ...
    "talentDetail.availabilityUnknown": "未設定",
    "talentDetail.availableFrom": "{date} から稼働可",
    "talentDetail.location": "居住地: {location}",
    "talentDetail.desiredPrice": "希望単価: {price}",
    "talentDetail.skillsEmpty": "スキル情報がありません",
    "talentDetail.matchesHeading": "マッチしたプロジェクト",
    "talentDetail.matchesCount": "{count} 件",
    ...
    "talentDetail.actions.viewProject": "プロジェクトで見る",
    "talentDetail.decision.success": "「{decision}」に更新しました",
    "talentDetail.decision.error": "更新に失敗しました: {message}",
    "talentDetail.status.pending": "保留",
    "talentDetail.status.proposed": "提案済み",
    "talentDetail.status.accepted": "受諾",
    "talentDetail.status.in_project": "プロジェクト進行中",
    "talentDetail.status.rejected": "見送り",
  },
} as const;
