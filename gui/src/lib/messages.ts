export const MESSAGES = {
  en: {
    ...
    "talents.filters.title": "Search & Filters",
    "talents.filters.description": "Search talents by name, skill, location, or availability.",
    "talents.filters.search": "Keyword",
    "talents.filters.searchPlaceholder": "Name, role, or keyword",
    "talents.filters.skill": "Skill",
    "talents.filters.skillPlaceholder": "e.g. React, Rust",
    ...
    "talents.filters.availabilityPlaceholder": "YYYY-MM or immediate",
    "talents.filters.apply": "Apply filters",
    "talents.resultCount": "{count} talents",
    "talents.loading": "Loading talents...",
    "talents.empty": "No talents match the current filters.",
  ...
  ja: {
    ...
    "talents.title": "タレント一覧",
    "talents.subtitle": "利用可能なタレントを検索・フィルタできます。",
    "talents.filters.title": "検索とフィルタ",
    "talents.filters.description": "氏名・スキル・居住地・稼働開始時期で絞り込みます。",
    "talents.filters.search": "キーワード",
    "talents.filters.searchPlaceholder": "氏名・ロール・キーワード",
    "talents.filters.skill": "スキル",
    "talents.filters.skillPlaceholder": "例: React, Rust",
    "talents.filters.location": "居住地",
    "talents.filters.locationPlaceholder": "市区町村・地域",
    "talents.filters.availability": "稼働開始",
    "talents.filters.availabilityPlaceholder": "YYYY-MM または 即日",
    "talents.filters.apply": "フィルタを適用",
    "talents.resultCount": "{count} 名",
    "talents.loading": "タレントを読み込み中...",
    "talents.empty": "条件に合うタレントが見つかりません。",
